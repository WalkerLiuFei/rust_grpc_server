...
fn serialize_json_raw<S>(value: &String, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
{
...
fn deserialize_json_raw<'de, D>(deserializer: D) -> Result<String, D::Error>
    where
        D: Deserializer<'de>,
{
...
mod test_mod {
    ...
    fn test_serialize_json_raw() {
        ...
        assert_eq!(deserialized.body, json,"test body failed");
